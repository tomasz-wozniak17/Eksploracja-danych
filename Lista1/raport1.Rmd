...
```{r wykresy_slupkowe, echo=FALSE, warning=FALSE, message=FALSE, fig.width=7.5, fig.height=8.5, fig.align='center', fig.cap="Rozkłady zmiennych jakościowych"}
# 1. Staż
...
# Magia patchwork: 2 na górze, 1 na dole, jedna wspólna legenda pod spodem!
(d1 + d2) / d3 + plot_layout(guides = "collect") & theme(legend.position = "bottom")
```

## Wykresy dla zmiennych jakościowych z podziałem na grupy 

```{r slupki_grupy_rozszerzone, echo=FALSE, warning=FALSE, message=FALSE, fig.width=7, fig.height=7, fig.align='left', fig.cap="Wybrane zmienne jakościowe w podziale na grupy", fig.pos="!h"}
...
c4 <- ggplot(dane, aes(x = PaymentMethod, fill = Churn)) +
  ...
  theme_minimal() +
  # Obracamy napisy na osi X, bo nazwy płatności są bardzo długie
  theme(axis.text.x = element_text(angle = 15, hjust = 1))

# Sklejamy w siatkę 2x2 i robimy jedną wspólną legendę na dole!
