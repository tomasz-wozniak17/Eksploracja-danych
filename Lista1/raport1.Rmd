...
## Zmienne jakościowe 
```{r wykresy_slupkowe, echo=FALSE, warning=FALSE, message=FALSE,fig.pos='!h',fig.width=7.5, fig.height=10, fig.align='center', fig.cap="Rozkłady najciekawszych zmiennych jakościowych"}
